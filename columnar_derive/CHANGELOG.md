...
## [0.13.0](https://github.com/frankmcsherry/columnar/compare/columnar_derive-v0.12.1...columnar_derive-v0.13.0) - 2026-05-23

### Changed

- Generated `AsBytes` implementations now emit `SLICE_COUNT` and `get_byte_slice`, tracking the trait's move to random-access byte slices ([#104](https://github.com/frankmcsherry/columnar/pull/104))
